...
import ProductFilter, { FilterValues } from '@/components/modules/products/ProductFilter';
import {
...
const ProductDetails = () => {
  ...
  const [filters, setFilters] = useState<FilterValues>({ keyword: '', productCode: '' });
  ...
  return (
    <>
      <Paper sx={{ overflow: 'hidden', p: 2, width: '100%' }}>
        ...
        <ProductFilter defaultValues={filters} onSubmit={handleFilterSubmit} />
