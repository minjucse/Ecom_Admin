    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: "Measurement",
            pageTitle: "Product Measurement",
            children: [
              { name: "New", path: "measurement", element: MeasurementEntry },
              { path: "measurement/:id", element: MeasurementEntry },
              { name: "List", path: "measurements", element: Measurements },
            ],
          },
          {
            name: "Attribute",
            ...
            children: [
              { name: "New", path: "attribute-group", element: AttributeGroupNew },
              { path: "attribute-group/:id", element: AttributeGroupNew },
              { name: "List", path: "attribute-groups", element: AttributeGroupList },
            ],
          },
          {
            name: "Attribute Value",
            pageTitle: "Product Attribute Value",
            children: [
              { name: "New", path: "attribute-value", element: AttributeValueEntry },
              { path: "attribute-value/:id", element: AttributeValueEntry },
              { name: "List", path: "attribute-values", element: AttributeValues },
            ],
          },
          {
            name: "Detail",
            ...
            children: [
              { name: "New", path: "productdetail", element: ProductDetailEntry },
              { name: "List", path: "productdetails", element: ProductDetail },
            ],
          },
        ],
      },
